    ...
    <>
      ...
      <div className="flex flex-col gap-8 sm:flex-row justify-between">
        <div className="flex flex-col items-start gap-8 rounded-lg sm:w-2/5">
          ...
          <a className="text-3xl sm:text-4xl text-blue-400 font-bold hover:underline cursor-pointer " href={`https://url-shortner-alpha-sandy.vercel.app/${link}`} target="_blank">https://url-shortner-alpha-sandy.vercel.app/{link}</a>
